...
root='/home/dmitrief/Sync/ownCloud/work/yeast_wall/analyze_pombe-master/pombe_3D_files/';
folders={'length_recover_2'};
nfolders=numel(folders);
count=0;
clear experiments;
c_pre=0;
% In the folders, there are directly pre & post !
for N=1:nfolders
	fname=[root,folders{N}];
	prename=[fname,'/pre/'];
	postname=[fname,'/post/'];
